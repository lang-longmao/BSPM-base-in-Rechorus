...
class LightGCNBase(object):
	...
	def forward(self, feed_dict):
		...
		# print("T ",items," ",items.shape)
		# print("A ",u_embed," ",i_embed," ",u_embed.shape," ",i_embed.shape)
		...
		i_v = i_embed
		# print("T ", u_embed,u_embed.shape)
		# print("A ", i_embed,i_embed.shape)
		# print(prediction.view(feed_dict['batch_size'], -1),prediction.view(feed_dict['batch_size'], -1).shape)
